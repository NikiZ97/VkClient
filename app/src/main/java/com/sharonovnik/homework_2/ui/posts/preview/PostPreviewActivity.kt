...
import com.sharonovnik.homework_2.ui.posts.ImageFullscreenActivity
import com.sharonovnik.homework_2.ui.posts.preview.comments.CommentAdapter
...
class PostPreviewActivity : AppCompatActivity() {
    ...
    private fun render(state: PostPreviewState) {
        ...
        with(state.postPreview) {
            ...
            postLayout.setPostPublicationDate(DateTimeConverter.getDateFromUnixTime(date.toLong()))
